...
class DHLDeliveryStrategyTest {
    ...
    @Test
    void deliver() {
        assertEquals("Delivery was made with DHL. Items: [Flower(price=10.0, sepalLength=0.0, color=null, flowerType=Chamomile), Flower(price=5.0, sepalLength=0.0, color=null, flowerType=Tulip)]", order.deliver());
    }
}